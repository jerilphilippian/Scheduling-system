<div>
    ...
    <div class="flex flex-1 flex-col px-24 bg-[url('/img/coverphoto.jpg')]bg-no-repeat bg-center bg-cover">
        <!-- Main -->
        <main class="flex flex-col px-8 flex-1 ">
          ...
          <!--bar event 1 start-->
      <div class="gap-5 mt-14 lg:grid lg:grid-cols-2 rounded-lg">
        <div class="w-full h-auto bg-white "
            style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <p class="flex items-center justify-center h-auto px-5 py-4 text-sm font-medium text-gray-800 ">Total Number Of
                Events Per Month</p>
...
<div date-rangepicker class="flex items-center justify-center">
    ...
    <div class="relative">
      ...
      <input name="end" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
        ...
        <div class="w-full h-auto bg-white rounded-lg"
            style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <p class="flex items-center justify-center h-auto px-5 py-4 text-sm font-medium text-gray-800 ">Total
    ...
    <!--bar 1 event end-->
          ...
          <!--2nd box graph-->
          <div class="w-full h-auto col-span-2 mt-6 bg-white rounded-lg"
          style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); display: flex; flex-direction: column;">
          <p class="flex items-center justify-center px-5 my-3 font-medium text-gray-800" style="white-space: pre-line;">Total Number Of Use Rooms Per Month</p>
          <div class="flex items-start m-8 w-11/12 sm:w-9/12 md:w-10/12 ">
