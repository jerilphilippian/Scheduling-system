                ...
                <nav class="text-white">
                    <ol class="inline-flex gap-1 p-0 list-none">
                                    <li class="flex items-end ">
                                        <p class="text-black"><a href="{{ route('user-management') }}">User Management</a></p>
                                    </li>
                    </ol>
                </nav>
			</div>
																				...
																				<div class="flex flex-row gap-2 mt-4">
																								...
																								<div class="w-28">
																												...
																												<select id="countries"
																																...
																																<option value="US">ASSOCIATE</option>
																																<option value="CA">POC</option>
																																<option value="CA">TEAM LEADER</option>
																																<option value="CA">SUPERVISOR</option>
																																<option value="CA">MANAGER</option>
																																<option value="CA">HEAD</option>
																																<option value="CA">DIRECTOR</option>
