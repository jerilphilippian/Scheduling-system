<div>
    ...
    <div class="flex flex-col flex-1 px-24 "style="height:100vh;">
        ...
        <main class="flex flex-col flex-1 ">
                <div class="w-full">
                    <p class="font-mono text-2xl font-bold text-black capitalize mb-7 animate__animated animate__bounceInLeft"><a href="{{route('room')}}">Room</a></p>
                   <!-- BREADCRUMBS -->
                ...
                <main class="container left-0 right-0 w-full mx-auto">
                    ...
                    <div class="w-full h-full p-6 mt-8 bg-white border border-gray-200 rounded-lg shadow ">
                        ...
                        <!-- Main modal -->
<div id="staticModal" wire:ignore.self data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
              <div class="p-2 px-4">
                <x-input wire:model="roomName" label="Room Name" required placeholder="Room Name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"/>
              </div>
              <div class="p-2 px-4">
                <x-inputs.number label='Capacity' wire:model='capacity' required type="name" id="capacity" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"/>
              </div>
              <div class="p-2 px-4">
                <x-textarea wire:model="description" label="Description" required placeholder="Your comment" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
              </div>
            ...
            <div class="flex items-center justify-end p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                ...
                <x-button wire:click='addRoom' red label="Add Room"/></button>
            </div>
        </div>
    </div>
</div>
