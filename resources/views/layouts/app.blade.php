          ...
          <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
            ...
            <div class="flex items-center justify-center flex-shrink-0 py-10">
              <a href="#">
                ...
                <img
                  class="w-24 h-auto"
                  src="{{asset('img/PMC-LOGO-removebg-preview.png')}}"
                  alt="K-UI"
                />
              </a>
            </div>
            ...
            <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
              <a href="#" class="flex items-center w-full space-x-2 text-white bg-[#860909] rounded-lg">
      ...
      <div class="flex flex-col flex-1">
        ...
        <div class="flex flex-1">
          ...
          <main class="flex flex-col px-8 flex-1 ">
            ...
            <!--2nd box graph-->
            <div class="w-full col-span-2 mt-6 bg-white h-80"
