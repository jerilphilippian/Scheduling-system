<div class="absolute items-center justify-center w-full">
    <footer class="relative bottom-0 h-16 p-6 mt-8 bg-white dark:bg-gray-800">
        <div class="mx-auto text-center">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#" class="hover:underline">Philippian Marketing Corporation</a>. All Rights Reserved.</span>
        </div>
      </footer>
</div>
